...
public class ElizonPermsVelocityCommand implements SimpleCommand {
    ...
    public void execute(SimpleCommand.Invocation invocation) {
        ...
        if (args.length < 3) {
            sender.sendMessage(Component.text("§f[§9EP§f] §9Usage for groups:\n" +
                    "  /epb group <name> info\n" +
            ...
            sender.sendMessage(Component.text("§f[§9EP§f] §cDATA MultiState can be set by player, but must be modified via Plugin API."));
            return;
        }
        ...
        if (targetType.equalsIgnoreCase("group")) {
            ...
            sender.sendMessage(Component.text("§f[§9EP§f] §cInvalid target type. Use 'group' or 'user'."));
        }
    }
        ...
        switch (actionType.toLowerCase()) {
            ...
            case "rankup":
                ...
                if(playerName.startsWith("uuid:")) {
                    ...
                    if(net.md_5.bungee.api.ProxyServer.getInstance().getPlayer(playerName) == null) {
                        player.sendMessage(Component.text("§f[§9EP§f] §cThe target player is offline. Use the uuid like this instead: \"uuid:UUID HERE\""));
                        return;
                    }
                    target = new PermPlayer(net.md_5.bungee.api.ProxyServer.getInstance().getPlayer(playerName).getUniqueId().toString());
                }
    ...
    private void handleGroupAction(CommandSource player, String targetName, String actionType, String[] args) {
        ...
        if (actionType.equalsIgnoreCase("permission")) {
            ...
            switch (action.toLowerCase()) {
                ...
                default:
                    player.sendMessage(
                            Component.text("§f[§9EP§f] §bCommand Help §f(/epb group " + targetName + " permission ... <string> <true|false|data>) \n" +
                                    "§f[§9EP§f] §9> §aadd\n" +
                                    "§f[§9EP§f] §9> §cremove\n" +
                                    "§f[§9EP§f] §9> §aset\n" +
                                    "§f[§9EP§f] §9> §ainfo")
            ...
            // Help message
            player.sendMessage(
                    Component.text("§f[§9EP§f] §bCommand Help §f(/epb group " + targetName + " <action>)\n" +
    ...
    private void handleUserAction(CommandSource player, String targetName, String actionType, String[] args) {
        ...
        if(targetName.toLowerCase().startsWith("uuid:")) {
            ...
            if(net.md_5.bungee.api.ProxyServer.getInstance().getPlayer(targetName) == null) {
            ...
            permPlayer = new PermPlayer(net.md_5.bungee.api.ProxyServer.getInstance().getPlayer(targetName).getUniqueId().toString());
        }
        ...
        if (actionType.equalsIgnoreCase("group")) {
            ...
            switch (action.toLowerCase()) {
                ...
                default:
                    player.sendMessage(
                            Component.text("§f[§9EP§f] §bCommand Help §f(/epb user " + targetName + " group ... <group>)\n" +
                                    "§f[§9EP§f] §9> §aadd\n" +
                                    "§f[§9EP§f] §9> §aaddtimed\n" +
                                    "§f[§9EP§f] §9> §cremove\n" +
                                    "§f[§9EP§f] §9> §aset\n" +
            ...
            switch (action.toLowerCase()) {
                ...
                case "info":
                    ...
                    break;
                default:
                    player.sendMessage(Component.text("§f[§9EP§f] §bCommand Help §f(/epb user " + targetName + " permission ... <string> <true|false|data>)\n" +
                            "§f[§9EP§f] §9> §aadd\n" +
                            "§f[§9EP§f] §9> §cremove\n" +
                            "§f[§9EP§f] §9> §aset\n" +
                            "§f[§9EP§f] §9> §ainfo"));
            ...
            player.sendMessage(
                    Component.text("§f[§9EP§f] §bCommand Help §f(/epb user " + targetName + " <action>)\n" +
                            "§f[§9EP§f] §9> §apermission\n" +
                            "§f[§9EP§f] §9> §ainfo")
            );
        }
